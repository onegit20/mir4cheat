...
long MyDmsoft::SetRowGapNoDict(long row_gap)
{
...
CString MyDmsoft::FindStrEx(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrE(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::DisAssemble(const TCHAR * asm_code,LONGLONG base_addr,long is_64bit)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicExS(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::OcrEx(long x1,long y1,long x2,long y2,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetColor(long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableFindPicMultithread(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetEnv(long index,const TCHAR * name,const TCHAR * value)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindPic(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetMinColGap(long col_gap)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::StringToData(const TCHAR * string_value,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetCommandLine(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableFontSmooth()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FreePic(const TCHAR * pic_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDisplayAcceler(long level)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::Ocr(long x1,long y1,long x2,long y2,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetWindowTitle(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::LockDisplay(long locks)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetPath(const TCHAR * path)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::BGR2RGB(const TCHAR * bgr_color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetEnumWindowDelay(long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindMulColor(long x1,long y1,long x2,long y2,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadDataAddr(long hwnd,LONGLONG addr,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetKeypadDelay(const TCHAR * tpe,long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDiskModel(long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::AppendPicAddr(const TCHAR * pic_info,long addr,long size)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetSpecialWindow(long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableMouseSync(long en,long time_out)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::KeyUpChar(const TCHAR * key_str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FaqCapture(long x1,long y1,long x2,long y2,long quality,long delay,long time)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::IsFolderExist(const TCHAR * folder)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetCursorShape()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableIme(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableKeypadPatch(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarLock(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::Assemble(LONGLONG base_addr,long is_64bit)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicMemE(long x1,long y1,long x2,long y2,const TCHAR * pic_info,const TCHAR * delta_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FloatToData(float float_value)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetShowAsmErrorMsg(long show)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindPicMem(long x1,long y1,long x2,long y2,const TCHAR * pic_info,const TCHAR * delta_color,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrFastS(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarDrawLine(long hwnd,long x1,long y1,long x2,long y2,const TCHAR * color,long style,long width)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDiskReversion(long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicSimEx(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,long sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadFileData(const TCHAR * file_name,long start_pos,long end_pos)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicSimE(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,long sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetRealPath(const TCHAR * path)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DmGuardLoadCustom(const TCHAR * tpe,const TCHAR * path)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WaitKey(long key_code,long time_out)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Play(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetWordResultStr(const TCHAR * str,long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarDrawPic(long hwnd,long x,long y,const TCHAR * pic,const TCHAR * trans_color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetKeyState(long vk)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::KeyDownChar(const TCHAR * key_str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::LoadPicByte(long addr,long size,const TCHAR * name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::OpenProcess(long pid)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::UseDict(long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ReadDataAddrToBin(long hwnd,LONGLONG addr,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::IsDisplayDead(long x1,long y1,long x2,long y2,long t)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetPicSize(const TCHAR * pic_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteFile(const TCHAR * file_name,const TCHAR * content)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarPrintText(long hwnd,const TCHAR * text,const TCHAR * color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteData(long hwnd,const TCHAR * addr,const TCHAR * data)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::DoubleToData(double double_value)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ImageToBmp(const TCHAR * pic_name,const TCHAR * bmp_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetPointWindow(long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
double MyDmsoft::ReadDouble(long hwnd,const TCHAR * addr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SendCommand(const TCHAR * cmd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetCursorPos(long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadIniPwd(const TCHAR * section,const TCHAR * key,const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindDataEx(long hwnd,const TCHAR * addr_range,const TCHAR * data,long steps,long multi_thread,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteDataAddr(long hwnd,LONGLONG addr,const TCHAR * data)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadData(long hwnd,const TCHAR * addr,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWordLineHeightNoDict(long line_height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableShareDict(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWordLineHeight(long line_height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SendStringIme(const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DeleteFolder(const TCHAR * folder_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetForegroundWindow()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetClientSize(long hwnd,long * width,long * height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DelEnv(long index,const TCHAR * name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CreateFoobarRect(long hwnd,long x,long y,long w,long h)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetClientSize(long hwnd,long width,long height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindMultiColor(long x1,long y1,long x2,long y2,const TCHAR * first_color,const TCHAR * offset_color,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDictMem(long index,long addr,long size)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindMultiColorE(long x1,long y1,long x2,long y2,const TCHAR * first_color,const TCHAR * offset_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDisplayInput(const TCHAR * mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindColor(long x1,long y1,long x2,long y2,const TCHAR * color,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SwitchBindWindow(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindStr(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SendString(long hwnd,const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarFillRect(long hwnd,long x1,long y1,long x2,long y2,const TCHAR * color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWindowState(long hwnd,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::RegEx(const TCHAR * code,const TCHAR * Ver,const TCHAR * ip)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DmGuard(long en,const TCHAR * tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetMouseSpeed(long speed)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWindowRect(long hwnd,long * x1,long * y1,long * x2,long * y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDisplayInfo()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWindowProcessId(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableKeypadSync(long en,long time_out)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindString(long hwnd,const TCHAR * addr_range,const TCHAR * string_value,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CreateFoobarEllipse(long hwnd,long x,long y,long w,long h)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteDoubleAddr(long hwnd,LONGLONG addr,double v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetPicPwd(const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::MoveDD(long dx,long dy)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::AddDict(long index,const TCHAR * dict_info)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SendStringIme2(long hwnd,const TCHAR * str,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FetchWord(long x1,long y1,long x2,long y2,const TCHAR * color,const TCHAR * word)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::VirtualProtectEx(long hwnd,LONGLONG addr,long size,long tpe,long old_protect)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ClientToScreen(long hwnd,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWindowState(long hwnd,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::Hex64(LONGLONG v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetExcludeRegion(long tpe,const TCHAR * info)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableSpeedDx(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::GetModuleBaseAddr(long hwnd,const TCHAR * module_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindWindowByProcessId(long process_id,const TCHAR * class_name,const TCHAR * title_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindShapeE(long x1,long y1,long x2,long y2,const TCHAR * offset_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetResultPos(const TCHAR * str,long index,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindColorEx(long x1,long y1,long x2,long y2,const TCHAR * color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::LockMouseRect(long x1,long y1,long x2,long y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarClearText(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CreateFoobarRoundRect(long hwnd,long x,long y,long w,long h,long rw,long rh)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetInputDm(long input_dm,long rx,long ry)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDict(long index,long font_index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDictInfo(const TCHAR * str,const TCHAR * font_name,long font_size,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumWindowSuper(const TCHAR * spec1,long flag1,long type1,const TCHAR * spec2,long flag2,long type2,long sort)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteDataFromBin(long hwnd,const TCHAR * addr,long data,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindInt(long hwnd,const TCHAR * addr_range,LONGLONG int_value_min,LONGLONG int_value_max,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindWindowByProcess(const TCHAR * process_name,const TCHAR * class_name,const TCHAR * title_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::RegExNoMac(const TCHAR * code,const TCHAR * Ver,const TCHAR * ip)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetParam64ToPointer()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FaqSend(const TCHAR * server,long handle,long request_type,long time_out)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumWindowByProcess(const TCHAR * process_name,const TCHAR * title,const TCHAR * class_name,long filter)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetResultCount(const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarClose(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindWindowSuper(const TCHAR * spec1,long flag1,long type1,const TCHAR * spec2,long flag2,long type2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FaqCaptureString(const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::HackSpeed(double rate)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumIniKey(const TCHAR * section,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindColorE(long x1,long y1,long x2,long y2,const TCHAR * color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DisableScreenSave()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindPicSim(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,long sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::StrStr(const TCHAR * s,const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DownCpu(long tpe,long rate)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::IsBind(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DecodeFile(const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetMinRowGap(long row_gap)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWordResultPos(const TCHAR * str,long index,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CapturePng(long x1,long y1,long x2,long y2,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindPicSimMem(long x1,long y1,long x2,long y2,const TCHAR * pic_info,const TCHAR * delta_color,long sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FreeProcessMemory(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindDouble(long hwnd,const TCHAR * addr_range,double double_value_min,double double_value_max)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
float MyDmsoft::ReadFloat(long hwnd,const TCHAR * addr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::ReadInt(long hwnd,const TCHAR * addr,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetClientRect(long hwnd,long * x1,long * y1,long * x2,long * y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDir(long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableGetColorByCapture(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumWindow(long parent,const TCHAR * title,const TCHAR * class_name,long filter)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableFakeActive(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableMouseAccuracy(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ScreenToClient(long hwnd,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDisplayDelay(long t)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteIni(const TCHAR * section,const TCHAR * key,const TCHAR * v,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::KeyPressChar(const TCHAR * key_str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindMultiColorEx(long x1,long y1,long x2,long y2,const TCHAR * first_color,const TCHAR * offset_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindShape(long x1,long y1,long x2,long y2,const TCHAR * offset_color,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::BindWindow(long hwnd,const TCHAR * display,const TCHAR * mouse,const TCHAR * keypad,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetScreen(long width,long height,long depth)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWindow(long hwnd,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetColorBGR(long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableRealKeypad(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ClearDict(long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetExitThread(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetDiskSerial(long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SendPaste(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicSimMemE(long x1,long y1,long x2,long y2,const TCHAR * pic_info,const TCHAR * delta_color,long sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::MoveTo(long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::RegNoMac(const TCHAR * code,const TCHAR * Ver)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetWindowClass(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetColorHSV(long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetCursorSpot()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteStringAddr(long hwnd,LONGLONG addr,long tpe,const TCHAR * v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrFastEx(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindShapeEx(long x1,long y1,long x2,long y2,const TCHAR * offset_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CmpColor(long x,long y,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetColorNum(long x1,long y1,long x2,long y2,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableKeypadMsg(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FaqGetSize(long handle)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FaqCaptureFromFile(long x1,long y1,long x2,long y2,const TCHAR * file_name,long quality)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::LoadPic(const TCHAR * pic_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDisplayRefreshDelay(long t)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindNearestPos(const TCHAR * all_pos,long tpe,long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicSimMemEx(long x1,long y1,long x2,long y2,const TCHAR * pic_info,const TCHAR * delta_color,long sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CopyFile(const TCHAR * src_file,const TCHAR * dst_file,long over)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetEnv(long index,const TCHAR * name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindStrFast(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetSystemInfo(const TCHAR * tpe,long method)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::RGB2BGR(const TCHAR * rgb_color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::MoveR(long rx,long ry)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicE(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetProcessInfo(long pid)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FaqPost(const TCHAR * server,long handle,long request_type,long time_out)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::TerminateProcess(long pid)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnablePicCache(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicMemEx(long x1,long y1,long x2,long y2,const TCHAR * pic_info,const TCHAR * delta_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetModuleSize(long hwnd,const TCHAR * module_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarUpdate(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindDoubleEx(long hwnd,const TCHAR * addr_range,double double_value_min,double double_value_max,long steps,long multi_thread,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetWindowProcessPath(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteDouble(long hwnd,const TCHAR * addr,double v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteInt(long hwnd,const TCHAR * addr,long tpe,LONGLONG v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableMouseMsg(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindWindow(const TCHAR * class_name,const TCHAR * title_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FreeScreenData(long handle)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetColGapNoDict(long col_gap)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::VirtualQueryEx(long hwnd,LONGLONG addr,long pmbi)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindColorBlockEx(long x1,long y1,long x2,long y2,const TCHAR * color,double sim,long count,long width,long height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWindowTransparent(long hwnd,long v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableRealMouse(long en,long mousedelay,long mousestep)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumIniSection(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ExecuteCmd(const TCHAR * cmd,const TCHAR * current_dir,long time_out)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::MoveToEx(long x,long y,long w,long h)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindData(long hwnd,const TCHAR * addr_range,const TCHAR * data)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarSetSave(long hwnd,const TCHAR * file_name,long en,const TCHAR * header)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Delays(long min_s,long max_s)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ActiveInputMethod(long hwnd,const TCHAR * id)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Log(const TCHAR * info)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Capture(long x1,long y1,long x2,long y2,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarTextRect(long hwnd,long x,long y,long w,long h)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStringEx(long hwnd,const TCHAR * addr_range,const TCHAR * string_value,long tpe,long steps,long multi_thread,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumProcess(const TCHAR * name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWordGap(long word_gap)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::ReadIntAddr(long hwnd,LONGLONG addr,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetFindPicMultithreadCount(long count)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteIniPwd(const TCHAR * section,const TCHAR * key,const TCHAR * v,const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetScreenData(long x1,long y1,long x2,long y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CheckInputMethod(long hwnd,const TCHAR * id)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrFastExS(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::Md5(const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetMemoryFindResultToFile(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
float MyDmsoft::ReadFloatAddr(long hwnd,LONGLONG addr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarUnlock(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetDictCount(long index)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindWindowEx(long parent,const TCHAR * class_name,const TCHAR * title_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteIntAddr(long hwnd,LONGLONG addr,long tpe,LONGLONG v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Reg(const TCHAR * code,const TCHAR * Ver)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CaptureGif(long x1,long y1,long x2,long y2,const TCHAR * file_name,long delay,long time)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetSimMode(long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DownloadFile(const TCHAR * url,const TCHAR * save_file,long timeout)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CapturePre(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CreateFolder(const TCHAR * folder_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::VirtualFreeEx(long hwnd,LONGLONG addr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteFloat(long hwnd,const TCHAR * addr,float v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindColorBlock(long x1,long y1,long x2,long y2,const TCHAR * color,double sim,long count,long width,long height,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteString(long hwnd,const TCHAR * addr,long tpe,const TCHAR * v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Int64ToInt32(LONGLONG v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarTextLineGap(long hwnd,long gap)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::SelectDirectory()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarSetTrans(long hwnd,long trans,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarSetFont(long hwnd,const TCHAR * font_name,long size,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::OcrInFile(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::DmGuardParams(const TCHAR * cmd,const TCHAR * sub_cmd,const TCHAR * param)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::SortPosDistance(const TCHAR * all_pos,long tpe,long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::MatchPicName(const TCHAR * pic_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindFloatEx(long hwnd,const TCHAR * addr_range,float float_value_min,float float_value_max,long steps,long multi_thread,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::VirtualAllocEx(long hwnd,LONGLONG addr,long size,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::MoveWindow(long hwnd,long x,long y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::IsFileExist(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ReadDataToBin(long hwnd,const TCHAR * addr,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumIniKeyPwd(const TCHAR * section,const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumIniSectionPwd(const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindFloat(long hwnd,const TCHAR * addr_range,float float_value_min,float float_value_max)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrFastE(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetExactOcr(long exact_ocr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetNetTimeSafe()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ExcludePos(const TCHAR * all_pos,long tpe,long x1,long y1,long x2,long y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EncodeFile(const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
double MyDmsoft::ReadDoubleAddr(long hwnd,LONGLONG addr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetForegroundFocus()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarStartGif(long hwnd,long x,long y,const TCHAR * pic_name,long repeat_limit,long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWordGapNoDict(long word_gap)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWindowSize(long hwnd,long width,long height)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetAveHSV(long x1,long y1,long x2,long y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteDataAddrFromBin(long hwnd,LONGLONG addr,long data,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetWordsNoDict(long x1,long y1,long x2,long y2,const TCHAR * color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::IntToData(LONGLONG int_value,long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::BindWindowEx(long hwnd,const TCHAR * display,const TCHAR * mouse,const TCHAR * keypad,const TCHAR * public_desc,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableDisplayDebug(long enable_debug)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::KeyPress(long vk)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::Beep(long fre,long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrWithFontEx(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,const TCHAR * font_name,long font_size,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DisablePowerSave()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarDrawText(long hwnd,long x,long y,long w,long h,const TCHAR * text,const TCHAR * color,long align)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::AsmAdd(const TCHAR * asm_ins)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrS(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetClipboard(const TCHAR * data)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetMachineCodeNoMac()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ShowScrMsg(long x1,long y1,long x2,long y2,const TCHAR * msg,const TCHAR * color)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::LockInput(long locks)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetScreenDataBmp(long x1,long y1,long x2,long y2,long * data,long * size)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadStringAddr(long hwnd,LONGLONG addr,long tpe,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DeleteFile(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CaptureJpg(long x1,long y1,long x2,long y2,const TCHAR * file_name,long quality)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SendString2(long hwnd,const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetOsBuildNumber()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetAveRGB(long x1,long y1,long x2,long y2)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDict(long index,const TCHAR * dict_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DeleteIniPwd(const TCHAR * section,const TCHAR * key,const TCHAR * file_name,const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetMousePointWindow()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::MoveFile(const TCHAR * src_file,const TCHAR * dst_file)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DeleteIni(const TCHAR * section,const TCHAR * key,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::EnumWindowByProcessId(long pid,const TCHAR * title,const TCHAR * class_name,long filter)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicEx(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,double sim,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::AsmCall(long hwnd,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetCursorShapeEx(long tpe)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::AsmCallEx(long hwnd,long mode,const TCHAR * base_addr)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetWindowText(long hwnd,const TCHAR * text)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrWithFontE(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,const TCHAR * font_name,long font_size,long flag)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarTextPrintDir(long hwnd,long dir)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::WriteFloatAddr(long hwnd,LONGLONG addr,float v)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DisableFontSmooth()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FoobarStopGif(long hwnd,long x,long y,const TCHAR * pic_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetFileLength(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SpeedNormalGraphic(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadIni(const TCHAR * section,const TCHAR * key,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindPicS(long x1,long y1,long x2,long y2,const TCHAR * pic_name,const TCHAR * delta_color,double sim,long dir,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetMachineCode()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetExportDict(long index,const TCHAR * dict_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetMouseDelay(const TCHAR * tpe,long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DmGuardExtract(const TCHAR * tpe,const TCHAR * path)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetShowErrorMsg(long show)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ShowTaskBarIcon(long hwnd,long is_show)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetDictPwd(const TCHAR * pwd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadFile(const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWindowThreadId(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindInputMethod(const TCHAR * id)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::CreateFoobarCustom(long hwnd,long x,long y,const TCHAR * pic,const TCHAR * trans_color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetNetTimeByIp(const TCHAR * ip)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SaveDict(long index,const TCHAR * file_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindIntEx(long hwnd,const TCHAR * addr_range,LONGLONG int_value_min,LONGLONG int_value_max,long tpe,long steps,long multi_thread,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::SetMemoryHwndAsProcessId(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::GetWords(long x1,long y1,long x2,long y2,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FaqRelease(long handle)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::FindStrWithFont(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim,const TCHAR * font_name,long font_size,long flag,long * x,long * y)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::GetWordResultCount(const TCHAR * str)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::KeyPressStr(const TCHAR * key_str,long delay)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::EnableBind(long en)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::DisableCloseDisplayAndSleep()
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::ReadString(long hwnd,const TCHAR * addr,long tpe,long length)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::ForceUnBindWindow(long hwnd)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::RunApp(const TCHAR * path,long mode)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::OcrExOne(long x1,long y1,long x2,long y2,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
long MyDmsoft::AsmSetTimeout(long time_out,long param)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
LONGLONG MyDmsoft::GetRemoteApiAddress(long hwnd,LONGLONG base_addr,const TCHAR * fun_name)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
...
CString MyDmsoft::FindStrExS(long x1,long y1,long x2,long y2,const TCHAR * str,const TCHAR * color,double sim)
{
    static DISPID dispatch_id = -1;
    MyDispatchDriver spDisp(obj);
    HRESULT hr;
